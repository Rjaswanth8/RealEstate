(function ($) {
  ...
  if ($(".company-supports-slider").length) {
    const company_supports_slider = new Swiper(
  ...
  if ($(".project-amenity-item-slider").length) {
    const testimonial_slider = new Swiper(
      ".project-amenity-item-slider .swiper",
      {
        slidesPerView: 1,
        speed: 1000,
        spaceBetween: 30,
  ...
  if ($(".testimonial-slider-moon").length) {
    const testimonial_slider_moon = new Swiper(
      ".testimonial-slider-moon .swiper",
      {
        slidesPerView: 1,
        speed: 1000,
        spaceBetween: 30,
  ...
  if ($(".testimonial-slider-prime").length) {
    const testimonial_slider_prime = new Swiper(
  ...
  document.querySelectorAll(".view-details-btn").forEach((btn) => {
    btn.addEventListener("click", function () {
      ...
      if (apartmentSwiper) apartmentSwiper.destroy(true, true);

      apartmentSwiper = new Swiper(".apartmentSwiper", {
        loop: true,
